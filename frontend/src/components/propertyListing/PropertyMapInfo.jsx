...
const PropertMapInfo = ({ address, extraInfo }) => {
  return (
    <>
      ...
      <div className="extra-info col-md-6 col-sm-12 col-12">
        ...
        <p className="extra-description">
          {(extraInfo?.trim() ? extraInfo.split("\n") : defaultText.split("\n"))
            .filter(Boolean)
    ...
    If you wish to check-in before 10am, an early check-in fee will be
    applicable. Late checkout is permitted based on availability and a
    fee may be applicable based on checkout time. Please contact the host
    regarding the same.`}
        </p>
      </div>
    </>
